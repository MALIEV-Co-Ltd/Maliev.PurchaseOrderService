...
/// </summary>
[ApiController]
[Route("purchase-orders/v1/purchase-orders")]
[Authorize]
public class PurchaseOrdersController : ControllerBase
{
    ...
    /// </summary>
    /// <remarks>Requires the caller to be authorized with the 'Employee' policy. Returns a 400 Bad Request if
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (ExternalServices.ExternalServiceException ex)
        {
    ...
    /// have permission to view the purchase order.</remarks>
    ...
    /// </summary>
    /// <remarks>The results are filtered based on the current user's identity and role. Only purchase orders
    /// accessible to the requesting user will be included in the response.</remarks>
    ...
    /// </summary>
    /// <remarks>Requires the caller to have the 'Manager' role. Returns a 404 Not Found response if the
    ...
    /// </summary>
    /// <remarks>This action requires the caller to have the 'Manager' role. The operation is performed
