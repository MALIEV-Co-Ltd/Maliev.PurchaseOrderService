...
namespace Maliev.PurchaseOrderService.Data.Migrations
{
    ...
    [Migration("20260111133436_InitialCreate")]
            ...
            modelBuilder.Entity("Maliev.PurchaseOrderService.Data.Entities.DomainEvent", b =>
                {
                    ...
                    b.HasIndex("CorrelationId")
                        .HasDatabaseName("ix_domain_events_correlation_id");

                    b.HasIndex("ProcessingAttempts")
                        .HasDatabaseName("ix_domain_events_processing_attempts");

                    b.HasIndex("EventType", "AggregateId")
                        .HasDatabaseName("ix_domain_events_event_type_aggregate_id");

                    b.HasIndex("IsProcessed", "OccurredAt")
                        .HasDatabaseName("ix_domain_events_is_processed_occurred_at");
            ...
            modelBuilder.Entity("Maliev.PurchaseOrderService.Data.Entities.OrderItem", b =>
                {
                    ...
                    b.HasIndex("ProductCode")
                        .HasDatabaseName("ix_order_items_product_code");
            ...
            modelBuilder.Entity("Maliev.PurchaseOrderService.Data.Entities.PurchaseOrder", b =>
                {
                    ...
                    b.HasIndex("OrderID")
                        .HasDatabaseName("ix_purchase_orders_order_id");
                    ...
                    b.HasIndex("CreatedBy", "Status")
                        .HasDatabaseName("ix_purchase_orders_created_by_status");

                    b.HasIndex("Status", "OrderType")
                        .HasDatabaseName("ix_purchase_orders_status_order_type");
            ...
            modelBuilder.Entity("Maliev.PurchaseOrderService.Data.Entities.PurchaseOrderFile", b =>
                {
                    ...
                    b.HasIndex("DocumentType")
                        .HasDatabaseName("ix_purchase_order_files_document_type");

                    b.HasIndex("ObjectName")
                        .IsUnique()
                        .HasDatabaseName("ix_purchase_order_files_object_name");

                    b.HasIndex("PurchaseOrderId")
                        .HasDatabaseName("ix_purchase_order_files_purchase_order_id");

                    b.HasIndex("UploadedBy")
                        .HasDatabaseName("ix_purchase_order_files_uploaded_by");
