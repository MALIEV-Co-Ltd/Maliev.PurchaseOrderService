...
public class SearchFilterTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public SearchFilterTests(WebApplicationFactory<Program> factory)
    {
        _factory = factory.WithWebHostBuilder(builder =>
        {
            builder.ConfigureServices(services =>
            {
                ...
                {
                    options.UseInMemoryDatabase("InMemoryDbForSearchTesting");
                });
            });
        });
    ...
    public async Task SearchPurchaseOrders_WithoutFilters_ShouldReturnAllOrders()
    {
        ...
        // Act
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders");
    ...
    public async Task SearchPurchaseOrders_FilterByStatus_ShouldReturnMatchingOrders()
    {
        ...
        // Act
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?status=Approved");
    ...
    public async Task SearchPurchaseOrders_FilterByOrderType_ShouldReturnMatchingOrders()
    {
        ...
        // Act
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?orderType=External");
    ...
    public async Task SearchPurchaseOrders_FilterBySupplier_ShouldReturnMatchingOrders()
    {
        ...
        // Act
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?supplierName=Alpha");
    ...
    public async Task SearchPurchaseOrders_FilterByDateRange_ShouldReturnMatchingOrders()
    {
        ...
        // Act
        var response = await _client.GetAsync($"/purchaseorders/api/purchase-orders?fromDate={fromDate}&toDate={toDate}");
    ...
    public async Task SearchPurchaseOrders_FilterByAmountRange_ShouldReturnMatchingOrders()
    {
        ...
        // Act
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?minAmount=10000&maxAmount=20000");
    ...
    public async Task SearchPurchaseOrders_WithSorting_ShouldReturnOrderedResults()
    {
        ...
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?sortBy=TotalAmountDesc");
    ...
    public async Task SearchPurchaseOrders_WithPagination_ShouldReturnPagedResults()
    {
        ...
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?page=1&pageSize=2");
    ...
    public async Task SearchPurchaseOrders_WithComplexFilter_ShouldReturnMatchingOrders()
    {
        ...
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?orderType=Internal&status=Pending&minAmount=4000");
    ...
    public async Task SearchPurchaseOrders_WithTextSearch_ShouldReturnMatchingOrders()
    {
        ...
        // Act
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?searchText=PO-2025-SEARCH-002");
    ...
    public async Task SearchPurchaseOrders_WithInvalidParameters_ShouldReturnValidationError()
    {
        ...
        var response = await _client.GetAsync("/purchaseorders/api/purchase-orders?pageSize=0");
