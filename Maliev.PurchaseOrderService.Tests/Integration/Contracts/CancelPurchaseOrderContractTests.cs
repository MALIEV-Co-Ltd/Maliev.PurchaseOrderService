...
/// <summary>
/// Contract tests for POST /purchaseorders/v1/purchase-orders/{id}/cancel endpoint
/// These tests MUST FAIL before implementation - following TDD principles
/// </summary>
public class CancelPurchaseOrderContractTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;
    private readonly HttpClient _client;
    private readonly string _baseUrl = "/purchaseorders/v1/purchase-orders";

    public CancelPurchaseOrderContractTests(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
